...
<div class="cmreg-help-shortcodes">
		<ul>
			<li><kbd>[cmreg-login]</kbd> - shortcode displays login button, optionally you can pass the button's text: <kbd>[cmreg-login]<strong>Text</strong>[/cmreg-login]</kbd></li>
			<li>You can add the login action on any element eg. menu link, using the CSS class: <kbd>cmreg-login-click</kbd></li>
			<?php if (App::isPro()): ?>
				<li><kbd>[cmreg-login-form]</kbd> - shortcode displays login form.</li>
				<li><kbd>[cmreg-registration-form]</kbd> - shortcode displays registration form.</li>
				<li><kbd>[cmreg-lost-password]</kbd> - shortcode displays lost password form.</li>
			<?php endif; ?>
		</ul>
</div>
