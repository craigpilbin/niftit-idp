...
<script>tinymce.init({ selector:'.modal-body textarea' });</script>
				...
				<ul class="nav navbar-nav navbar-right responsive-nav main-nav-list">
					<?php
						...
						if (is_user_logged_in()):
							...
							echo '<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">' . $current_user->display_name . '</a>
									<ul class="dropdown-menu">
										<li><a href="'. get_permalink(68) .'">My Profile</a></li>
										<li><a href="/wp-login.php?action=logout&redirect_to=/">Logout</a></li>';
							echo '</ul></li>';
							//echo '<li><a href="/wp-login.php?action=logout&redirect_to=/">Logout</a></li>';
						else:
							echo '<li><a href="' . get_permalink(4) .'" class="btn btn-primary">Signup</a></li>';
							 echo '<li><a href="' . get_permalink(63)  .'" class="btn btn-success">Login</a></li>';
						endif;
					?>
				</ul>
